...
class LocalProductRepository : ProductRepository  {
    private val all = listOf(
        ...
        Product("7","Master Navy Knit Sweater",65990,83990,"https://emestudios.com/cdn/shop/files/MASTER_NAVY_KNIT_SWEATER_1_97910c81-dead-4cbb-8f1c-bceed7274114.webp?v=1756678940",Category.Sweeter),
        Product("8","Gorra YVL",12990,null,"https://image-cdn.hypb.st/https%3A%2F%2Fhypebeast.com%2Fimage%2F2025%2F05%2F12%2Fplayboi-carti-yvl-hat-brand-launch-young-vamp-life-release-info-004.jpg?q=75&w=800&cbr=1&fit=max",Category.Accesorios),
        Product("9","Homer - Chain",98990,null,"https://www.homer.com/cdn/shop/files/Homer_Bullet_Hole_Pendant_with_Screws_M_Clover-Cody_Green_With_Chain__2048.png?v=1751551293&width=800",Category.Accesorios),
    )
